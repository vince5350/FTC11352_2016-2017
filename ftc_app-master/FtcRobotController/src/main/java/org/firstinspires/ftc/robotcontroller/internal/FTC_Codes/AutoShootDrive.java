 ...
 */
@Autonomous(name="AutoShootLeft")
public class AutoShootDrive extends LinearOpMode {
    ...
    DcMotor UptakeMotor; //Motor for uptake
    DcMotor motorIntake; //Motor for Intake
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // Step 1: Move robot forward for .2 seconds
        ...
        while(opModeIsActive() && runtime.seconds() < 0.8){
            motorLeft.setPower(forwardSpeed); //Starts robot moving forward.
            motorRight.setPower(backwardSpeed);
            telemetry.addData("Progress","Step 1: %2.5f s elapsed", runtime.seconds());
            telemetry.update();
        }
        ...
        //Step 8: continue to capball
        runtime.reset();
        while(opModeIsActive() && runtime.seconds() < convDistTime(forwardSpeed, 3.5)){
            motorLeft.setPower(backwardSpeed);
            motorRight.setPower(backwardSpeed);
        }
        idle();
