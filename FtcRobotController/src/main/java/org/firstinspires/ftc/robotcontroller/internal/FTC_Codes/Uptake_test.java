...
//@TeleOp(name="Uptake Test", group="Pushbot") // this registers it so you can you it on the FTC apps on the phone

public class Uptake_test extends OpMode{// this states that this code is writing on top of the previously built code "OpMode"
    ...
    boolean Conveyor; // this is the variable for the conveyor belt system
    boolean Rbump;
    boolean Lbump;
...
//-------------------------------------------------------------------------------------------------------
    ...
    public void init(){ // this is where the variables are listed to be called upon by void loop
        ...
        UptakeMotor = hardwareMap.dcMotor.get("Uptake"); // this is the conveyor belt motor
