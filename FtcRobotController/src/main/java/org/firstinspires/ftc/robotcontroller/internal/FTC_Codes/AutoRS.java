 ...
 */
@Autonomous(name="AutoRightStraight")
public class AutoRS extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive() && runtime.seconds() < convDistTime(forwardSpeed, 0.96)){
       ...
       while(opModeIsActive() && runtime.seconds() < 0.8){
            motorRight.setPower(forwardSpeed);
